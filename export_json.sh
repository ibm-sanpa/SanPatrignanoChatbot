...
echo $ASSISTANT_USERNAME
echo $ASSISTANT_PASSWORD
curl -H "Content-Type: application/json" -k -X get -u "$ASSISTANT_USERNAME":"$ASSISTANT_PASSWORD"  "$ASSISTANT_URL?version=2018-02-16&sort=stable&export=true&include_audit=false" > training/tmp.json
